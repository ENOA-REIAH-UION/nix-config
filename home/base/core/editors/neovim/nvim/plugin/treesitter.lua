...
vim.keymap.set({ "x", "o" }, "kf", function()
...
vim.keymap.set({ "x", "o" }, "kb", function()
...
vim.keymap.set({ "x", "o" }, "ka", function()
...
vim.keymap.set("n", "<leader>u", "<cmd>AerialToggle<CR>", { desc = "Toggle Aerial" })
